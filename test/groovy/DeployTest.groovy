...
class DeployTest extends BasePiperTest {
    ...
    private JenkinsStepRule neoDeployRule = new JenkinsStepRule(this, 'neoDeploy')
    private JenkinsStepRule cloudFoundryDeployRule = new JenkinsStepRule(this, 'cloudFoundryDeploy')
   ...
   private Map cloudFoundryDeployParameters = [:]
    ...
    void cfDeploymentTest() {
        ...
        assert cloudFoundryDeployRule.hasParameter('juStabUtils', utilsMock)
        assert cloudFoundryDeployRule.hasParameter('jenkinsUtilsStub', jenkinsUtilsMock)
